<?php
    ...
    { 
        ...
        // $sql="UPDATE appointment SET Doc_ID = '$doc_id', Pat_ID = '$pat_id', Name = '$ippatname', Age = '$age', Aadhar = '$aadhar', Phone = '$phone', App_Date = '$date', App_Time = '$time', Symptoms = '$symp') WHERE ID = '$id' ";
        
        $sql="UPDATE appointment SET Doc_ID ="." '$doc_id'".", Pat_ID = "."'$pat_id'".", Name = "."'$ippatname'".", Age = "."'$age'".", Aadhar = "."'$aadhar'".", Phone = "."'$phone'".", App_Date = "."'$date'".", App_Time = "."'$time'".", Symptoms = "."'$symp'"." WHERE ID = "."'$id' ";
        // echo $sql;

        // $sql = "UPDATE user SET picture =" . "'$photo'" . ", name=" . "'$name'".", summary="."'$summary'".", about="."'$about'" .", interest="."'$interests'". ", education="."'$education'" .", experience="."'$experience'"." WHERE email="."'$email'";
        ...
        <?php
            header('Location: /Doctor-System/Patient/Edit/Edit.php');
        }
        else
            echo "fail";
    }
        ...
        <div style="width: 100%; height: 100%;">
            <form name="patient_form" action="" method="post">
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="inputname" placeholder="Name" style="width: 450px;" value="<?php echo $row['Name']?>">
                        </td>
                        <td>
                            <label name="inputage">Patient Age</label>
                        </td>
                        <td>
                            <input type="number" name="inputage" placeholder="Age" min=1 max=150 style="width: 450px;" value="<?php echo $row['Age']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="tel" pattern="[0-9]{4} [0-9]{4} [0-9]{4}" name="inputaadhar" placeholder="xxxx xxxx xxxx" style="width: 450px;" value="<?php echo $row['Aadhar']?>">
                        </td>
                        <td>
                            <label name="inputphone">Phone Number</label>
                        </td>
                        <td>
                            <input type="tel" pattern="[0-9]{10}" name="inputphone" placeholder="Phone Number" style="width: 450px;" value="<?php echo $row['Phone']?>">
                        </td>
                    </tr>
                </table>
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="inputSymptoms" placeholder="Symptoms" style="width: 1005px;" value="<?php echo $row['Symptoms']?>">
                        </td>
                    </tr>
                </table>
                <br><br>                
                <table>
                    <tr>
                        ...
                        <td>
                            <input id='inputDate' type="date" name="inputDate" placeholder="Date" style="width: 450px;" min="<?php echo date("Y-m-d");?>" value="<?php echo $row['App_Date']?>">
                        </td>
                        <td>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <select name="inputTime" required style="width: 450px;" value="<?php echo $row['App_Time']?>">
                ...
                <tr>
                    <td>
                        <button type="submit" style="color: black;" name="formsubmit">Update Appointment</button>
                    </td>
                </tr>
            </table>
        </form>
